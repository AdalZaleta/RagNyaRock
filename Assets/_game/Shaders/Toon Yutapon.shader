...
Shader "Retus001/ToonYutapon" {
    Properties {
        ...
        _TesselationPower ("TesselationPower", Range(1, 10)) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float3 node_5635 = (_YutaponHeightBuffer_var.rgb*_YutaponOffsetDirection.rgb);
                v.vertex.xyz += node_5635;
...
////// Emissive:
                ...
                float3 finalEmission = saturate((1.0-(1.0-_YutaponCutsBuffer_var.rgb)*(1.0-(Diffuse*node_5673))));
